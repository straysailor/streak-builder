            ...
            <div className="flex flex-col rounded-xl bg-teal-700 p-6">
                ...
                <form className="grid grid-cols-1 gap-y-2">
                    <div className="flex justify-between">
                        ...
                        <input type="email" name="email" required className="bg-gray-900 rounded-md mx-2"></input>
                    </div>
                    <div className="flex justify-between">
                        <label htmlFor="password">Password:</label>
                        <input type="password" name="password" required className="bg-gray-900 rounded-md mx-2"></input>
                    </div>
